    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='category', to='events.CategoryEvent', verbose_name='Категория')),
                ...
                ('tags', models.ManyToManyField(blank=True, null=True, to='events.TagEvent', verbose_name='Теги')),
            ],
            options={
